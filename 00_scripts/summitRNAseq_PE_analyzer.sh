...
do
  ...
  sample1=${sample1[$counter]}
  echo -e "\n $sample1"

  sample2=${sample2[$counter]}
  echo -e "\n $sample2"     
  ...
  echo -e "\n FASTP quality reports are located in:\n $fastpReport"
    ...
    ## execute fastp
    cmd1="$fastp -i ${inputdir}${sample1}${suffix} -I ${inputdir}${sample2}${suffix} -o ${fastpTrim}${sample1}_trim${suffix} -O ${fastpTrim}${sample2}_trim${suffix} --json=${sample1}_report.json --html=${sample1}_report.html"
    echo -e "\t $ ${cmd1}"
    time eval $cmd1
